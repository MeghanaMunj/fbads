    ...
    def get_insight_formatted(self,i_screenfield):
        ...
        for lw_insights in self.insights:
            ...
            for lw_fields, lv_value in lw_insights.iteritems():
                ...
                if self.lt_breakdown != None and lw_fields in self.lt_breakdown:
                    ...
                    for lw_screenfield in i_screenfield:
                        ...
                        if lv_pos > 0:
                            lv_pre = lw_selfield[:lv_pos]
                            lv_post = lw_selfield[lv_pos+1:]
                            ...
                            lv_post = ""
                            lw_row[lw_screenfield] = lw_insight.get(lw_screenfield)
                        #if lv_pos != -1:
