...
class fbadsManager(ThreePBase):
    ...
    def __init__(self, storage_handle, api_config):
        ...
        self.apid = '1843616625966235'
        self.secret = '91966604942d8a082dc23e2b82d310c6'
        self.adsapi = None
    ...
    def get_ds_config_spec(self, ds_config_spec,
        ...
        """
        print('\n\n\nDS Config specs ----------------------------',ds_config_spec)
        print('\n\n\nIdenfity config ----------------------------',identity_config)
        print('\n\n\nParams ---------------------------------',params)
    ...
    def list_profiles(self, identity_config):
        ...
        lv_apid = self.apid
        lv_fbads = facebookapi.FbGraph(lv_access_token,lv_apid,self.secret)
